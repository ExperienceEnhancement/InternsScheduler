...
function angularInit(element, bootstrap) {
  var elements = [element],
      appElement,
      module,
      names = ['ng:components', 'ng-components', 'x-ng-components', 'data-ng-components'],
 ...
 * @returns {AUTO.$injector} Returns the newly created injector for this components.
 */
 ...
 * it must be below the `ng-components` definition.
 * 
...
function createHttpBackend($browser, XHR, $browserDefer, callbacks, rawDocument, locationProtocol) {
  ...
  return function(method, url, post, callback, headers, timeout, withCredentials, responseType) {
    ...
    if (lowercase(method) == 'jsonp') {
      ...
      // response is in the cache. the promise api will ensure that to the components code the api is
      // always async
 ...
 * @example
   <doc:example module="customInterpolationApp">
     <doc:source>
      ...
      <div ng-components="App" ng-controller="DemoController as demo">
          //demo.label//
      </div>
     </doc:source>
     <doc:scenario>
 ...
 *
 * - your components is hosted at url `http://myapp.example.com/`
